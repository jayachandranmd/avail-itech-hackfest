            ...
            Padding(
              ...
              child: SizedBox(
                ...
                child: ElevatedButton(onPressed: (){
                  setState(() {
                    updated = PostTag.keys.where(
                            (element) => PostTag[element] == true);
                    if (kDebugMode) {
                      print(updated);
                    }
                  });
                  ...
                  child: const Text('Post',style: TextStyle(fontSize: 20,fontWeight: FontWeight.w700,color: Colors.black)),
                ),
              ),
            )
          ],
            ...
            child: Column(
              children: [
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: ListTile(
                            ...
                            title: Text('Name',style: textFieldTitle,),
                ...
                Padding(
                  ...
                  child: Row(
                    children: [
                      Text('Tags',style: textFieldTitle,),
                          ...
                          child: OutlinedButton(
                            ...
                            setState(() {
                              ...
                              style: OutlinedButton.styleFrom(
                                  ...
                                  backgroundColor: values[index]==true?HexColor('#FEED5F'):white,
                                  side: BorderSide(color:HexColor('#FEED5F') ),
                                  primary: HexColor('#FEED5F'),
                              ),
                              child: Row(
                                children: [
                                  CachedNetworkImage(
                                    ...
                                    height: 20,),
                                  sBoxW5,
                                  Text(tags[index],style: textFieldpara,)
